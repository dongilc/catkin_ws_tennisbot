...
private:
  ...
  void setCustomsCallback(const vesc_msgs::VescSetCustomApp::ConstPtr& custom_set_msg);
  void aliveCallback(const std_msgs::Bool::ConstPtr& alive);
  void timerCallback(const ros::TimerEvent& event);
  void dutyCycleCallback(const vesc_msgs::VescSetCommand::ConstPtr& duty_cycle);
  void currentCallback(const vesc_msgs::VescSetCommand::ConstPtr& current);
  void speedCallback(const vesc_msgs::VescSetCommand::ConstPtr& speed);
  void brakeCallback(const vesc_msgs::VescSetCommand::ConstPtr& brake);
  void positionCallback(const vesc_msgs::VescSetCommand::ConstPtr& position);
  void servoCallback(const vesc_msgs::VescSetCommand::ConstPtr& servo);
};
